...
import by.innowise.orderservice.dto.ErrorDto;
...
public class GlobalControllerExceptionHandler {
    @ExceptionHandler(value = {NotEnoughProductsInInventoryException.class, InsufficientFundsException.class,
            NoOrderWithIdExistsException.class, NoProductsInOrderException.class})
